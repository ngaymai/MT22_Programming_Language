...
class LexerSuite(unittest.TestCase):
    ...
    def test_identifier4(self):
        self.assertTrue(TestLexer.test("01ancmds _abc 12mckm","0,1,ancmds,_abc,12,mckm,<EOF>",104))
    ...
    def test_keyword1(self):
        self.assertTrue(TestLexer.test("01anc mds For c brEaK 21mc continuE km","0,1,anc,mds,For,c,brEaK,21,mc,continuE,km,<EOF>",111))
    ...
    def test_operator1(self):
        self.assertTrue(TestLexer.test("ddsls<l>02>=d1s<=123","ddsls,<,l,>,0,2,>=,d1s,<=,123,<EOF>",131))
    ...
    def test_unclose_String1(self):
        self.assertTrue(TestLexer.test("\"bacxyc","bacxyc",151))
